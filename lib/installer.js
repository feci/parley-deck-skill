...
// it is a directory the rest of the chain is `mkdir -p`'s problem, and if it is anything else —
// a regular file, a dangling link, an unreadable entry — no write below it can ever succeed.
